...
const Hero = () => {
  ...
  return (
<section id="hero" className={`bg-[url('/images/hero/slider/pic2.jpg')] bg-opacity-25 w-full lg:pb-24  bg-center bg-no-repeat bg-cover duration-300 transition-opacity  lg:bg-[url('/images/hero/slider/pic1.png')]`} >
