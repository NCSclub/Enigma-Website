...
<Marquee speed={60} pauseOnHover direction >
  <ul className="flex space-x-9 overflow-hidden   ">
    {logosData.map((logo, index) => (
      <li key={index} className='bg-[#0B0D2F] overflow-hidden ml-6   bg-gradient-to-r from-[#0B0D2F] to-[#151851] shadow-2xl bg-opacity-40 rounded-3xl p-12 flex justify-center items-center'>
